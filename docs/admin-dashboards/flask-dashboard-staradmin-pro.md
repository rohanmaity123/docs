title: Flask Dashboard StarAdmin PRO

# [Flask Dashboard](http://appseed.us/admin-dashboards/flask) - [Star Admin PRO](https://appseed.us/admin-dashboards/flask-dashboard-staradmin-pro)

**Commercial** Admin Dashboard coded in [Flask Framework](https://palletsprojects.com/p/flask/) on top of **StarAdmin Dashboard** design (PRO Version) designed by BootstrapDash Agency - product generated by AppSeed.
...
- UI Kit: **[StarAdmin Dashboard PRO](https://www.bootstrapdash.com/product/star-admin-pro/?ref=appseed)** provided by **BootstrapDash**
...
- [Flask Dashboard StarAdmin PRO](https://github.com/app-generator/flask-dashboard-staradmin-pro) - The public repository, used for bug tracking and licensing information
