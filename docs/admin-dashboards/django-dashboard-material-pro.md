...
**Commercial** Admin Dashboard coded in **[Django Framework](https://www.djangoproject.com/)** on top of **[Material Dashboard](https://demos.creative-tim.com/marketplace/black-dashboard-pro/docs/1.0/getting-started/introduction)** design (PRO Version) designed by Creative-Tim Agency - product generated by AppSeed.
...
- [Django Dashboard Material PRO](https://github.com/app-generator/django-dashboard-material-pro) - The public repository, used for bug tracking and licensing information
- [Django Dashboard Material PRO](https://django-dashboard-black.appseed.us/login) - LIVE demo
