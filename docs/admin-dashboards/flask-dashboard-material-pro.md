...
**Commercial** Admin Dashboard coded in [Flask Framework](https://palletsprojects.com/p/flask/) on top of **Material Dashboard** design (PRO Version) designed by Creative-Tim Agency - product generated by AppSeed.
